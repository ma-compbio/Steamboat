...
# %%
resolutions = [1.5] # clustering resolution for Leiden clustering
pca_dims = [30] # number of dimensions to keep after PCA
...
for i, adata in enumerate(tqdm(adatas)):
    ...
    if 'banksy' in adata.obs.columns:
        adata.obs[['banksy']].to_csv(f"../SpaceFormer/experiments/backup/mmbrain/banksy_cell_type_{i}.csv")
...
# %%
df.to_csv("../SpaceFormer/experiments/backup/mmbrain/banksy_cell_type.csv")
